...
public class SubmissionService {
    ...
    public Submission submit(String email, MultipartFile image) throws IOException {
    ...
    @Async
    public void sendEmailWithImageLink(String email, URL presignedUrl) {
        try {
